...
def get_args():
    ...
    parser.add_argument('--CpGfile', '-i', type=str, required=True, help="The bedGraph output of pileOMeth with chromosome, CpG position, %DNA me, reads with C, reads with T. The program expects the output in an _unstranded_ fashion, i.e., pileOMeth must have been used with --mergeContext.")
